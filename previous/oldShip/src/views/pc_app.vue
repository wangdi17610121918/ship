		...
		<div class="ship-details-wrap">
			...
			<div class="ship-details">
				<table>
					<tbody>
						<tr>
							<td class="ship-details-td-title">船型：</td>
							<td class="ship-details-td-content">{{shipMessage.shipType}}</td>
							<td class="ship-details-td-title">状态：</td>
							<td class="ship-details-td-content">{{shipMessage.shipCondition}}</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="ship-details-td-title">呼号：</td>
							<td class="ship-details-td-content">{{shipMessage.callSign}}</td>
							<td class="ship-details-td-title">国籍：</td>
						...
						<tr>
							...
							<td class="ship-details-td-content">{{shipMessage.SDWT | NumFormat}}</td>
						...
						<tr>
							<td class="ship-details-td-title">最新时间：</td>
							<td class="ship-details-td-content">{{shipMessage.newTime}}</td>
							<td class="ship-details-td-title">航速：</td>
							<td class="ship-details-td-content">{{shipMessage.shipSpeed}}节</td>
						</tr>
						<tr>
							<td class="ship-details-td-title">吃水：</td>
							<td class="ship-details-td-content">{{shipMessage.shipWaterline}}m</td>
							<td class="ship-details-td-title">最大吃水：</td>
							<td class="ship-details-td-content">{{shipMessage.shipFullWaterline}}m</td>
						</tr>
						<tr>
							<td class="ship-details-td-title">装载状态：</td>
							<td class="ship-details-td-content">{{shipMessage.loadCn}}</td>
							<td class="ship-details-td-title"></td>
							<td class="ship-details-td-content"></td>
						</tr>
						<tr>
							<td class="ship-details-td-title">目的地：</td>
							<td class="ship-details-td-content">{{shipMessage.destination}}</td>
							<td class="ship-details-td-title">ETA：</td>
							<td class="ship-details-td-content">{{shipMessage.ETA}}</td>
						</tr>
						<tr>
							<td class="ship-details-td-title">始发港：</td>
							<td class="ship-details-td-content">{{shipMessage.shipInitial}}</td>
							<td class="ship-details-td-title">当前海区：</td>
							<td class="ship-details-td-content">{{shipMessage.nowSeaArea}}</td>
						</tr>
					</tbody>
				</table>
				<div class="ship-footer">
					提示：本平台使用谷歌地图，为了使您获得最佳的查询航速航线体验，<br>建议使用谷歌浏览器
				</div>
			</div>
		</div>
