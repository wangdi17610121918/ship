<template>
	<section>
		<!--船舶资料-->
		<div class="inner">
			<div class="tide-title"><a href="javascript:;" @click="getActive()">首页</a>&gt;&gt;<a href="/page/" class="cur">贸易物流</a>&gt;&gt;<a href="javascript:;" class="cur">船舶资料</a></div>
			<div class="basic-box">
				<ul class="basic-query1 clearfix">
					<li class="basic-query-blo1">
						<p class="clearfix"><span>英文名</span><input v-model="name" type="text" ></p>
						<p class="clearfix"><span>船舶代码</span><input v-model="imo" type="text" ></p>
						<p class="clearfix">
							<span>船舶类型</span>
					...
					<li class="basic-query-blo2"><a href="javascript:;" @click="submitFn">查询</a></li>
				</ul>
