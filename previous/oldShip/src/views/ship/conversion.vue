<template>
	<section>
		<!--单位换算-->
		<div class="inner">
			<div class="tide-title"><a href="javascript:;" @click="getActive()">首页</a>&gt;&gt;<a href="/page/" class="cur">贸易物流</a>&gt;&gt;<a href="javascript:;" class="cur">单位换算</a></div>
			<div class="dwhs-box clearfix">
				<div class="common-tooln-top tide-search-top">
					<span class="tide-search-title">单位换算</span>
				...
				<div class="conversion-box">
	               <i class="shipping-ico ico-chi"></i>
	               	<ul class="dwhs-con">
		                <li>
		                	<el-input v-model="inputL1" placeholder="请输入内容"  class="ry-dwhs-int con_inputL1" size="small" type='number'></el-input>
		                	<span>Farenheit</span>
		                </li>
		                <li class="dwhs-con-r ry-dis">
		                	<el-input v-model="inputR1"  placeholder="换算结果"  class="ry-dwhs-int con_inputR1" size="small" type='number'></el-input>
		                	<span>Celsius</span>
	               	...
	               	<ul class="dwhs-con">
		                <li>
		                	<el-input v-model="inputL2" placeholder="请输入内容"  class="ry-dwhs-int con_inputL2" size="small" type='number'></el-input>
		                	<span>API</span>
		                </li>
		                <li class="dwhs-con-r ry-dis">
		                	<el-input v-model="inputR2" placeholder="换算结果"  class="ry-dwhs-int con_inputR2" size="small" type='number'></el-input>
		                	<span>SG@60°F</span>
	               	...
	               	<ul class="dwhs-con">
		                <li>
		                	<el-input v-model="inputL3" placeholder="请输入内容"  class="ry-dwhs-int con_inputL3" size="small" type='number'></el-input>
		                	<span>Long Tons</span>
		                </li>
		                <li class="dwhs-con-r ry-dis">
		                	<el-input v-model="inputR3" placeholder="换算结果"  class="ry-dwhs-int con_inputR3" size="small" type='number'></el-input>
	               	...
	               	<ul class="dwhs-con">
		                <li>
		                	<el-input v-model="inputL4"  placeholder="请输入内容"  class="ry-dwhs-int  con_inputL4" size="small" type='number'></el-input>
		                	<span>Factor BBLS@60°F</span>
		                </li>
		                <li class="dwhs-con-r ry-dis">
		                	<el-input v-model="inputR4" placeholder="换算结果"  class="ry-dwhs-int con_inputR4" size="small" type='number'></el-input>
		                	<span>m³@15°C</span>
