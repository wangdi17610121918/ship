<template>
    <div style="user-select: auto;" @click="fuzzySearchBlur($event)">
        ...
        <div class="sr-layout">
            <div class="sr-header">
                <div class="sr-logo" @click="getActiveIndex()">航速航线规划</div>
                <ul class="sr-layout-right">
                    <li class="sr-nav-item">
                        <a href="javascript:;" class="setting-ship-map ship-map-setting" title="设置" @click="shipMapSetting">
                            <i class="fs fs-cog setting-ship-map-i"></i>
                        </a>
                    </li>
                    <li class="sr-nav-item mar-left-10" v-if="userStorage == null">
                        <a href="javascript:;" class="setting-ship-map ship-map-exit" title="登录" @click="registerClick">
                            <i class="fs fs-user setting-ship-map-i"></i>
                        </a>
                    </li>
                    <li class="sr-nav-item mar-left-10" v-if="userStorage != null">
                        <a href="javascript:;" class="setting-ship-map ship-map-exit" title="退出" @click="signOut()">
            ...
            <div class="sr-side">
                ...
                <div class="sr-side-scroll">
                    <div class="sr-search">
                        <input class="sear_input" type="text" placeholder="船名/IMO" value="" @input="fuzzySearch"
                               @focus="fuzzySearchShow()"
                    ...
                    <div class="tf_form menu_item_form typhoonWrap" data-value="1">
                        ...
                        <div class="legend tf_row">
                            <div class="item"><i class="solid_circle bg_color_1"></i>热带低压</div>
                            <div class="item"><i class="solid_circle bg_color_2"></i>热带风暴</div>
                            <div class="item"><i class="solid_circle bg_color_3"></i>强热带风暴</div>
                            <div class="item"><i class="solid_circle bg_color_4"></i>台风</div>
                            <div class="item"><i class="solid_circle bg_color_5"></i>强台风</div>
                            <div class="item"><i class="solid_circle bg_color_6"></i>超强台风</div>
                        </div>
                        <div class="tf_search tf_row typhoonSearch" style="cursor: pointer">查询</div>
                    </div>
                    <!--气象海况-->
                    <div class="gk-search mar-top-10 menu_down clickClearMsg">
                        <a class="qx_show"><i class="fs fs-weather-infor"></i>气象海况<i
                                class="icon_down fs fs-chevron-down"></i></a>
                    </div>
                    ...
                    <!--海盗军演-->
                    <div class="gk-search mar-top-10 menu_down clickClearMsg">
                        <a class="hd_show"><i class="fs fs-haidaojunyan"></i>海盗军演<i
                                class="icon_down fs fs-chevron-down"></i></a>
                    </div>
                    <div class="hd_form menu_item_form pirate-wrap"
                        ...
                        <div class="hd_row">
                            ...
                            <select class="select selectTime">
                                <option selected value="1">最近一个月</option>
                        ...
                        <div class="hd_search hd_row warSearch">查询</div>
                    </div>
                </div>
            </div>
            <div class="sr-body">
                ...
                <div style="position:absolute;left: 212px;height: 100%;width: 100%;top: 0;">
                    ...
                    <div class="pannel_table pannel_10 reach-popout zIndexZoom portTable3 hide" id="sr-d3">
                        <div class="sr-dialog3 sr-d-3">
                            <div class="pannel_title  sr-d8-title">
                                ...
                                <span class="name">靠港记录</span>
                                <span class="details">共<span class="color_orange">{{total1}}</span>条</span>
                                <!--<a class="export"  :href="exportMsg">导出数据</a>-->
                                <a href="#" class="close sr-close8"><i class="fs fs-close"></i></a>
                            </div>
                            <div class="pannel_content contentWrap">
                                <div class="headContainer">
                                    <div class="tableHead tableRowOne">
                                        <div class="item">序号</div>
                                        <div class="item">港口中文</div>
                                        <div class="item">港口英文</div>
                                        <div class="item">国家</div>
                                        <div class="item">ATA</div>
                                        <div class="item">ATD</div>
                                        <div class="item">到港吃水</div>
                                        <div class="item">离港吃水</div>
                                        <div class="item">港口作业时间（/h）</div>
                                        <div class="item">码头作业时间（/h）</div>
                                ...
                                <div class="tableBody tableBody3 sr-d8-body">
                                    <div class="tableRow tableRowOne tableRowOne3" v-for="(list,index) in reachLogs1"
                                        ...
                                        <div class="item">{{list.portNameEn}}</div>
                                        <div class="item">{{list.counrtyCn}}</div>
                    ...
                    <div class="pannel_weather pannel_23 sr-dialog zIndexZoom hide"
                        ...
                        <div class="pannel_title">
                            <div class="tab_item active">{{threeWeathertitle}}日</div>
                            <div class="tab_item">{{threeWeathertitle1}}日</div>
                            <div class="tab_item">{{threeWeathertitle2}}日</div>
                        ...
                        <div class="pannel_content infobody" v-show='index==0'
                            ...
                            <div class="high_low">
                                <div class="item" v-for='higWaters in threeWeatherbodys.tides.higWaters'>
                                    高潮:{{higWaters.waterTime}}&nbsp;&nbsp;{{higWaters.water}}
                                </div>
                            </div>
                            <div class="high_low">
                                <div class="item" v-for='lowWaters in threeWeatherbodys.tides.lowWaters'>
                                    低潮:{{lowWaters.waterTime}}&nbsp;&nbsp;{{lowWaters.water}}
                                </div>
                            </div>
                            <div class="weather_info" v-for='weathers in threeWeatherbodys.weathers'>
                                <div class="weather_top">{{weathers.date}}时&nbsp;&nbsp;{{weathers.weather}}</div>
                                    ...
                                    <div class="info">
                                        <div class="clearfix">
                                            ...
                                            <div class="item item2">
                                                <label>风：</label>
                                                <span>{{weathers.winddirection}}/{{Number(weathers.windspeed).toFixed(2)}}节</span>
                                            </div>
                                            <div class="item">
                                                <label>浪高：</label>
                    ...
                    <!-- 历史航线历史参考数据 -->
                    <div class="pannel_table_3 pannel_24 hide sr-dialog zIndexZoom"
                         style="position: absolute; top:350px; left:250px;">
                        <div class="pannel_title">
                            <span class="name">历史参考数据</span>
                            <a class="close"><i class="fs fs-close" @click="historyClose()"></i></a>
                        </div>
                        <div class="table_container">
                            <table>
                                <tr>
                                    <th class="tabel_title">航程</th>
                                    <th class="tabel_title">历史航速（knots）</th>
                                    <th class="tabel_title">历史目的港停留时间(H)</th>
                                </tr>
                                <tr v-for="recomendSpeeds in recomendSpeedH">
                                    <td class="tabel_cell">{{recomendSpeeds.fromNameCn}}<img class="arrow_link"
                                                                                             src="../../static/images/ship/arrow_10.png">{{recomendSpeeds.toNameCn}}
                                    </td>
                        ...
                        <div class="bottom_info">全程平均历史航速-{{recomendSpeed}}节-总共用时{{totalDays}}天</div>
                    </div>
                    <!-- 实时航线历史参考数据 -->
                    <div class="pannel_table_3 hide nowSpeedD sr-dialog zIndexZoom"
                        ...
                        <div class="table_container">
                            <table>
                                ...
                                <tr v-for="recomendSpeedNs in recomendSpeedN">
                                    <td class="tabel_cell">{{recomendSpeedNs.fromNameCn}}<img class="arrow_link"
                                                                                              src="../../static/images/ship/arrow_10.png">{{recomendSpeedNs.toNameCn}}
                                    </td>
                        ...
                        <div class="bottom_info">全程平均历史航速-{{recomendSpeed2}}节-总共用时{{totalDays2}}天</div>
                    </div>

                    <!--&lt;!&ndash; 港口信息 hide&ndash;&gt;
                    <div class="pannel_port pannel_26 sr-dialog zIndexZoom hide"
                        ...
                        <div class="weather_info"><span>{{initPortCurrent}}</span>&nbsp;&nbsp;<span>{{portNew}}</span>
                            <a class="port_icon" @click="portWeathers" style="color:#fff"><i
                                    class="fs-qixiang bg_color_24"></i></a></div>
                    ...
                    <div class="pannel_port_weather pannel_27 hide sr-dialog zIndexZoom"
                        ...
                        <div class="pannel_content clearfix">
                            <div class="_left">
                                ...
                                <div class="_one">现在：{{leftinfo.weather}}</div>
                                <div class="_one">气压：{{leftinfo.pressure}}</div>
                                <div class="_one">气温：{{leftinfo.temperature}}℃</div>
                                <div class="_one">降雨：{{leftinfo.rain}}mm</div>
                                <div class="_one">风：{{leftinfo.winddirection}}/{{leftinfo.windspeed}}级</div>
                                <div class="_one">湿度：{{leftinfo.humidity}}%</div>
                            </div>
                            <div class="_right">
                                <div class="item" v-for="weekW in rightinfo">
                                    ...
                                    <div class="_one">{{weekW.weather}}</div>
                                    <div class="_one">{{weekW.maxtemp}}℃ | {{weekW.mintemp}}℃</div>
                                    <div class="_one">日出：{{weekW.sunrise}}</div>
                                    <div class="_one">日落：{{weekW.sunset}}</div>
                                    <div class="_one">降雨概率：{{weekW.rainchance}}%</div>
                                    <div class="_one">风：{{weekW.winddirection}}/{{weekW.windspeed}}级</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- 台风查询结果 -->
                    <div class="pannel_table_2 pannel_20 sr-dialog zIndexZoom hide" style="width: 25%">
                        <div class="pannel_title">
                        ...
                        <div class="table_container">
                            <table>
                                <tr>
                                    ...
                                    <th class="tabel_title">日期</th>
                                    <th class="tabel_title">编号</th>
                                </tr>
                                <tr v-for="typhoonResults in typhoonResult">
                                    <td class="tabel_cell can_click posCenter"
                                        @click="detailedTyphoon(typhoonResults.positions, typhoonResults.typhoon.chnname)">
                                        {{typhoonResults.typhoon.chnname}}
                                    </td>
                    ...
                    <div class="pannel_table_2 pannel_21 sr-dialog zIndexZoom hide">
                        <div class="pannel_title">
                            <span class="name">[{{typhoonName}}] 路径信息</span>
                        ...
                        <div class="table_container" style="height: 248px;">
                            <table>
                                <tr>
                                    <th class="tabel_title">时间</th>
                                    <th class="tabel_title">风速</th>
                                    <th class="tabel_title">移动方向</th>
                                    <th class="tabel_title">强度</th>
                                </tr>
                    ...
                    <!-- 船舶信息 -->
                    <div v-drag class="ship_pannel_two pannel_9 sr-d1 zIndexZoom" style="display: none;">
                        <div class="pannel_title sr-dialog-title drag-title-el">
                            ...
                            <div class="img_container" style="top:8px;">
                                <div class="btn_name">{{this.ifCollect == 0?'收藏到我的船队':'取消收藏'}}</div>
                        ...
                        <div class="column_container">
                            <div class="column_two">
                                ...
                                <div class="text">{{shipMessage.shipCondition}}</div>
                            </div>
                            <div class="column_two">
                            ...
                            <div class="column_two">
                                ...
                                <div class="name">国籍/地区：</div>
                                <div class="text">
                                    <span>{{shipMessage.displayCountryCn}}</span>
                        ...
                        <div class="column_container">
                            <div class="column_two">
                                ...
                                <div class="name">航速：</div>
                                <div class="text">{{shipMessage.shipSpeed}}节</div>
                            </div>
                            <div class="column_two">
                                <div class="name">吃水：</div>
                                <div class="text">{{shipMessage.shipWaterline}}m</div>
                                <div class="name">最大吃水：</div>
                                <div class="text">{{shipMessage.shipFullWaterline}}m</div>
                            </div>
                            <div class="column_two">
                                <div class="name">装载状态：</div>
                                <div class="text">{{shipMessage.loadCn}}</div>
                            </div>
                            <div class="column_two">
                                <div class="name">目的地：</div>
                                <div class="text" style="white-space: nowrap">{{shipMessage.destination}}</div>
                                <div class="name">ETA：</div>
                                <div class="text">{{shipMessage.ETA}}</div>
                            </div>
                            <div class="column_two">
                                <div class="name">始发港：</div>
                                <div class="text">{{shipMessage.shipInitial}}</div>
                                <div class="name">当前海区：</div>
                                <div class="text">{{shipMessage.nowSeaArea}}</div>
                            </div>
                            <div class="column_two lastli">
                                <div class="name sr-d1-label">时间范围：</div>
                        ...
                        <div class="operate">
                            <div class="item tryQuery">轨迹查询</div>
                            <div class="item abolish" style="display: none; background:#D9B300;">清除轨迹</div>
                            <div class="item harborSearch" @click="harborSearch">靠港查询</div>
                            <div class="item laoShiDangAn" @click="laoShiDangAn">船舶档案</div>
                            <div class="item routeLineActive routeLineClick" @click="routeLine(shipMessage.MMSI)">航线航速</div>
                            <div class="item boat-details " @click="isLogin">船盘详情</div>
                            <!--<router-link class="item boat-details" style="color:#fff" tag="a" target="_blank" :to="{path:'/bootinfo',query:{imo:shipMessage.IMO,mmsi:shipMessage.MMSI,type:3}}" @click.native="isLogin">船盘详情</router-link>-->
                        </div>
                        <div class="tips">提示：本平台使用谷歌地图，为了使您获得最佳的查询航速航线体验，建议使用谷歌浏览器</div>
                    </div>

                    <!-- 劳氏档案 -->
                    <div class="ship_pannel_three pannel_11 zIndexZoom sr-dialog hide" style="top:50px;left:50px;">
                        <div class="pannel_title">
                            <span class="f_ship"><i class="fs-ships"></i></span>
                            <span class="name">船舶档案</span>
                            <a href="javascript:;" class="close record-close"><i class="fs fs-close"></i></a>
                        </div>
                        <div class="pannel_content">
                            <div class="column_container">
                                ...
                                <div class="column_three">
                                    <div class="name">经济航速：</div>
                                    <div class="text">{{daliao.basic.serviceSpeed}}Kt’s</div>
                                </div>
                            </div>
                            <div class="column_container">
                                ...
                                <div class="column_three">
                                    ...
                                    <div class="text ellipsis_line_1" :title="daliao.pis.pi">{{daliao.pis.pi}}</div>
                                </div>
                            </div>
                            <div class="column_container">
                            ...
                            <div class="column_container">
                                ...
                                <div class="column_three">
                                    <div class="jianyanjilu" v-for="classfication in daliao.classfications"
                                         :title="classfication.content">{{classfication.content}}
                                    </div>
                                </div>
                            </div>
                            <div class="column_container">
                                <div class="sub_title">PSC</div>
                                <div style="padding: 5px 0; border-bottom: 1px solid #383838;"
                                     v-for="psc in daliao.pscs">
                                    <div class="column_three">
                                        <div class="name">PSC组织：</div>
                                        <div class="text text2">{{psc.pscOrganization}}</div>
                                        <div class="name">PSC检查机关：</div>
                    ...
                    <div class="pannel pannel_1 sr-dialog hide is-port-drag zIndexZoom" style="white-space: nowrap">
                        <div class="pannel_title">
                            ...
                            <span class="name">港口查询</span>

                            <a href="javascript:;" class="close search-port-close"><i class="fs fs-close"></i></a>
                            <!-- <a href="javascript:;" class="close dialog-minZoom" @click="dialogMinZoom({name:'港口查询', className:'.pannel_1', id:'a9gk89j'})">_</a>-->
                        </div>
                        <div class="pannel_content">
                            <div class="row">
                                ...
                                <div class="text">
                                    <select class="select_d3 select-port-1" v-model="loadPort1">
                                        ...
                                        <option v-for="item in loadPortArr" :value="item.portNameEn">{{item.portName}}
                                        </option>
                                    </select>
                                    <button class="button search-button">查询</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="name">查询条件：</div>
                                <div class="text">
                                ...
                                <div class="text" v-show="portDataValue==2">
                                    <div class="time">
                                        <el-date-picker prefix-icon="fs-calendar" v-model="time5" class="timeP2"
                                                        size="mini" type="datetime" placeholder="选择日期"
                    ...
                    <!-- 港口记录、当前 -->
                    <div class="pannel_table pannel_6 portTable zIndexZoom" id="sr-d9">
                        <div class="sr-dialog9 sr-d9">
                            <div class="pannel_title  sr-d8-title">
                                <span href="javascript:;" class="f_search"><i class="fs-search"></i></span>
                                <span class="name">当前在港记录</span>
                                <span class="details">共<span class="color_orange">{{portLog1.length}}</span>艘，总载重<span
                                        class="color_orange">{{zaiZhong1.pageSize | NumFormat}}</span>吨</span>
                                <a :href="export1" class="export export-1">导出数据</a>
                            ...
                            <div class=" pannel_content contentWrap scrollTable">
                                <div class="headContainer">
                                    <div class="tableHead tableRowOne">
                                        <div class="item">序号</div>
                                        <div class="item">船名</div>
                                        <div class="item">IMO</div>
                                        <div class="item">MMSI</div>
                                        <div class="item">船舶类型</div>
                                        <div class="item">载重吨</div>
                                        <div class="item">最大吃水</div>
                                        <div class="item">到港吃水</div>
                                        <div class="item">上一港</div>
                                        <div class="item" style="width: 120px;">ATA</div>
                                        <div class="item">在港时间(h)</div>
                                        <div class="item" style="width: 17px;visibility: hidden;">.</div>
                                    </div>
                                </div>
                    ...
                    <!-- 港口记录、预计 -->
                    <div class="pannel_table pannel_7 portTable1 zIndexZoom" id="sr-d10">
                        <div class="sr-dialog10 sr-d10">
                            <div class="pannel_title  sr-d8-title">
                                <span href="javascript:;" class="f_search"><i class="fs-search"></i></span>
                                <span class="name">预计到港记录</span>
                                <span class="details">共<span class="color_orange">{{portLog2.length}}</span>艘，总载重<span
                                        class="color_orange">{{zaiZhong2.pageSize | NumFormat}}</span>吨</span>
                                <a :href="export2" class="export export-2">导出数据</a>
                                <a href="javascript:;" class="close sr-close8 close-window-1"><i
                                        class="fs fs-close"></i></a>
                            </div>
                            <div class="table-wrap">
                            ...
                            <div class="pannel_content contentWrap scrollTable">
                                ...
                                <div class="tableBody tableBody10">
                                    <div class="tableRow tableRowOne tableRowOne10"
                                        ...
                                        <div class="item">{{portList.mmsi}}</div>
                                        <div class="item">{{portList.sdwt | NumFormat}}</div>
                                        <div class="item">{{portList.vesselSizeCn}}</div>
                                        <div class="item">{{portList.draft}}</div>
                                        <div class="item">{{portList.draught}}</div>
                                        <div class="item">{{portList.lastPortCn}}</div>
                    ...
                    <!-- 港口记录、历史 -->
                    <div class="pannel_table pannel_8 portTable2 zIndexZoom" id="sr-d11">
                        <div class="sr-dialog11 sr-d11">
                            <div class="pannel_title  sr-d8-title">
                                <span href="javascript:;" class="f_search"><i class="fs-search"></i></span>
                                <span class="name">历史到港记录</span>
                                <span class="details">共<span class="color_orange">{{portLog3.length}}</span>艘，总载重<span
                                        class="color_orange">{{zaiZhong3.pageSize | NumFormat}}</span>吨</span>
                                <a :href="export3" class="export export-3">导出数据</a>
                                <a href="javascript:;" class="close sr-close8 close-window-1"><i
                                        class="fs fs-close"></i></a>
                            </div>
                            <div class="table-wrap">
                    ...
                    <div class="pannel pannel_2 sr-d7 sr-dialog zIndexZoom  hide ">
                        <div class="pannel_title">
                            ...
                            <span class="name">历史航线</span>
                            <a href="javascript:;" class="close haven-close"><i class="fs fs-close"></i></a>
                        </div>
                        <div class="pannel_content">
                            <div class="row">
                                <div class="name sr-label">发货港：</div>
                                <div class="text">
                                    <input class="sear_inputPort sear_inputFrom" type="text" placeholder="请输入港口"
                                           value=""
                                           @input="fuzzySearchFrom"
                                           @focus="fuzzySearchFrom"
                                    ...
                                    <button class="button sr-btn add-btn search-btnHistory" @click='addBtnHistory'>查询
                                    </button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="name">收货港：</div>
                                <div class="text">
                            ...
                            <div class="row">
                                ...
                                <div class="text load-wrap">
                                    <input type="text" class="text_input" v-model="num1" placeholder="请输入">
                                    <em>-</em>
                                    <input type="text" class="text_input" v-model="num2" placeholder="请输入">
                                    <em>Mt</em>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="name sr-label">时间范围：</div>
                                <div class="text">
                                    <div class="time">
                    ...
                    <div class="pannel_table pannel_3 zIndexZoom" id="sr-d8">
                        <div class="sr-dialog8 sr-d8">
                            <div class="pannel_title  sr-d8-title">
                                ...
                                <span class="details">共<span class="color_orange">{{historyTotal}}</span>条</span>
                                <a class="export" :href="exportMsg">导出数据</a>
                                <a href="#" class="close sr-close8"><i class="fs fs-close"></i></a>
                            </div>
                            <div class="pannel_content contentWrap">
                                <div class="headContainer">
                                    <div class="tableHead tableRowOne">
                                        ...
                                        <div class="item">船舶类型</div>
                                        <div class="item">最大吃水</div>
                                        <div class="item">离港吃水(发货港)</div>
                                        <div class="item">到港吃水(到达港)</div>
                                        <div class="item">始发港</div>
                                        <div class="item">始发地区</div>
                                        <div class="item">ATD</div>
                                        <div class="item">途径港</div>
                                        <div class="item">目的港</div>
                                        <div class="item">ATA</div>
                                        <div class="item" style="width: 17px;visibility: hidden;">.</div>
                                    </div>
                                </div>
                                <div class="tableBody tableBody8 sr-d8-body">
                                    <div class="tableRow tableRowOne tableRowOne8"
                                        ...
                                        <div class="item">{{reachLog.vesselSizeTypeCN}}</div>
                                        <div class="item">{{reachLog.draft}}</div>
                                        <div class="item">{{reachLog.draughtOut}}</div>
                                        <div class="item">{{reachLog.draughtIn}}</div>
                                        <div class="item">{{reachLog.fromPortCN}}</div>
                                        <div class="item">{{reachLog.fromCounrtyCN}}</div>
                                        <div class="item">{{reachLog.atd | timestampFormat}}</div>
                                        <div class="item" :title="reachLog.subPortsCN">{{reachLog.subPortsCN}}</div>
                                        <div class="item">{{reachLog.toPortCN}}</div>
                    ...
                    <div class="pannel_table pannel_4 route_history hide sr-dialog zIndexZoom flex-tabel">
                        <div class="pannel_title">
                            ...
                            <span class="name">航速航线</span>
                            <span class="check_group">
                            <span class="line-speed-type" data-value="VLCC">船型：</span>
                            ...
                            <div class="details_2">
                                <span class="item">距离：<span class="color_orange" v-model="totalDistance">{{totalDistance.toFixed(2)}}</span>海里</span>
                                <span class="item">天数：<span class="color_orange">{{totalDays}}</span>天</span>
                                <span class="item">
                                    <span>速度：</span>
                                <input type="number" class="text_input line-speed-speed" @input="speedChange"
                                       value="13.0" step="0.5" v-model="speedSpeed" min="0">
                                <span>节</span>
                                </span>
                                <span class="item" v-if="recomendSpeed != 0">
                                    <span @click="historyOpen()" class="hover-status"
                                          style='cursor: pointer;color: #3B99FC;font-weight: 700;'>历史航速：</span>
                        ...
                        <div class="pannel_content contentWrap">
                            <div class="headContainer">
                                <div class="tableHead tableRowOne">
                                    <div class="item">序号</div>
                                    <div class="item">港口</div>
                                    <div class="item">时区</div>
                                    <div class="item">距离(NM)</div>
                                    <div class="item">航速(节)</div>
                                    <div class="item">航行天数</div>
                                    <div class="item">港口停留时间(h)</div>
                                    <div class="item">预计到港时间</div>
                                    <div class="item">预计离港时间</div>
                                    <div class="item" style="width: 17px;visibility: hidden;">.</div>
                                </div>
                            </div>
                            <div class="tableBody tableBody1">
                                <div class="tableRow tableRowOne">
                                    ...
                                    <div class="item" style="text-align: left">
                                        <el-select clearable prefix-icon="fs-calendar" class="line-value"
                                                   v-model="lineVal1" filterable auto-complete="on" @change="copyMsg"
                                                   @clear="clearText(0)" default-first-option remote reserve-keyword
                                                   placeholder="请输入港口" :loading="loadingText"
                                ...
                                <div class="tableRow tableRowOne tableRowOneHover" v-model="lineList"
                                    ...
                                    <div class="item" style="text-align: left">
                                        <el-select clearable prefix-icon="fs-calendar" class="line-value"
                                                   v-model="lineItem.value" @change="copyMsg2"
                                                   :title="listArr[index].title"
                                    ...
                                    <!--<div class="item">{{lineItem.endTime - lineItem.startTime | timeNum}}</div>-->
                                    <!--<div class="item">{{lineItem.dateStartStr}}</div>-->
                                ...
                                <!--<div class="tableRow tableRowOne">
                                    ...
                                    <div class="item">
                                        <input type="text" class="text_input portChoose" placeholder="">
                                        <a class="f_pen hide"><i class="fs-edit2"></i></a>
                                    </div>
                                    <div class="item">9397157</div>
                                    <div class="item">15</div>
                                    <div class="item">8</div>
                                    <div class="item">8</div>
                                    <div class="item">2018-03-15 21:00</div>
                                    <div class="item">2018-03-15 21:00</div>
                                </div>
                                <div class="tableRow tableRowOne">
                        ...
                        <div class="operate">
                            <span class="calculate calculate1">计算</span>
                            <span class="item remove-line" @click="clearList">清空</span>
                            <span class="item" @click="toUpList">上移</span>
                            <span class="item" @click="toDownList">下移</span>
                            <span class="item" @click="insertLine">插入行</span>
                            <span class="item" @click="deleteLine">删除行</span>
                        </div>
                        <div class="pannel_table_footer" style="background: none">
                            <span class="color_orange">*</span>
                            <span class="color_gray_1">计算结果仅供参考</span>
                    ...
                    <div class="pannel_table pannel_4 route_now hide sr-dialog zIndexZoom flex-tabel">
                        <div class="pannel_title">
                            ...
                            <span class="name">航速航线</span>
                            <div class="details_2">
                                <span class="item">距离：<span class="color_orange" v-model="totalDistance2">{{totalDistance2.toFixed(2)}}</span>海里</span>
                                <span class="item">天数：<span class="color_orange">{{totalDays2}}</span>天</span>
                                <span class="item">
                                    <span>速度：</span>
                                ...
                                <span class="item" v-if="recomendSpeed2 != 0">
                        ...
                        <div class="pannel_content contentWrap">
                            <div class="headContainer">
                                <div class="tableHead tableRowOne">
                                    ...
                                    <div class="item">港口停留时间(h)</div>
                                    <div class="item">预计到港时间</div>
                                    <div class="item">当地时间/预计离港时间</div>
                                    <div class="item" style="width:0px;visibility: hidden;flex:auto;">.</div>
                                </div>
                            </div>
                            <div class="tableBody tableBody2">
                                ...
                                <div class="tableRow tableRowOne tableRowOneHover"
                                    ...
                                    <div class="item">{{index + 2}}</div>
                                    <div class="item" style="text-align: left">
                                        <el-select clearable prefix-icon="fs-calendar" class="line-value" filterable
                                                   :loading="loadingText" loading-text="加载中..." v-model="lineItem.value"
                                                   default-first-option remote reserve-keyword placeholdxer="请输入港口"
                        ...
                        <div class="operate">
                            <span class="calculate calculate2">计算</span>
                            <span class="item remove-line" @click="clearList2">清空</span>
                            <span class="item" @click="toUpList2">上移</span>
                            <span class="item" @click="toDownList2">下移</span>
                            <span class="item" @click="insertLine2">插入行</span>
                            <span class="item" @click="deleteLine2">删除行</span>
                        </div>
                        <div class="pannel_table_footer " style="background: none">
                            <span class="color_orange">*</span>
                            <span class="color_gray_1">计算结果仅供参考</span>
                    ...
                    <ul class="dialog-min-zoomList">
                        <li v-for="zoomItem in dialogMinZoomList" @click="dialogZoomShow(zoomItem)">
                            {{zoomItem.name}}
                            <i class="fs fs-plus" style="margin-left:10px;"></i>
                        </li>
                    </ul>
                    ...
                    <div class="my-ships-wrap sr-dialog zIndexZoom bg-color-default my-ships-wrap-js hide">
                        <div class="my-ships-header">
                            ...
                            <span class="pad-5">我的船队</span>
                            <span class="font14" v-show="myShipsArr.length!=0"> 共 <span class="color-yellow">{{myShipsArr.length==0? 0 : myShipsArr.length}}</span> 艘 </span>
                        ...
                        <div>
                            <table v-show="myShipsArr.length!=0">
                                ...
                                <tr class="my-ships-tr-js" v-for="(myShipsArrs, index) in myShipsArr" :dataLat="myShipsArrs.lat" :dataLng="myShipsArrs.lng" :dataImo="myShipsArrs.imo">
                                    ...
                                    <td class="text-blu my-ships-unfollow"><span @click.stop="unfollow(myShipsArrs.imo, myShipsArrs.mmsi)">取消关注</span></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="port-details-wrap sr-dialog background-greyLight zIndexZoom hide">
                        ...
                        <div class="port-details-content">
                            <div class="pad-bottom-10">
                                <p class="font18 text-333">{{initPortName}}</p>
                                <div class="font14 pad-top-5">
                                    <span>{{initPortCurrent}}</span>
                                    <span class="pad-left-5">.{{leftinfo.weather}}</span>
                                    <a class="port_icon dis-inline-block mar-left-10" @click="portWeathers" v-show="leftinfo.weatherEn != null" style="color:#fff;">
                                        <i class="fs-qixiang bg_color_24" title="港口天气"></i>
                                    </a>
                                </div>
                                <div class="port-details-circle" @click="portDetailsInfo(initPortNameEn)" v-show="infoPortType != null">
                                    详情
                                </div>
                            </div>
                    ...
                    <div class="port-details-info sr-dialog zIndexZoom hide">
                        <div class="port-details-info-header">
                            <h2 class="" v-text="portInfo.titleZh"></h2>
                            <a href="javascript:;" class="port-details-close" @click="portInfoClose">
                                <i class="fs fs-close text-gray"></i>
                            </a>
                        </div>
                        <div class="port-details-info-content" v-html="portInfo.htmlZh"></div>
                    </div>
                    ...
                    <div class="port-queuing-wrap sr-dialog zIndexZoom hide">
                        <div class="port-queuing-header">
                            ...
                            <span class="pad-5">{{initPortName}} {{isPortDate}} 港口排队计划</span>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr v-for="item in portQueuingArr">
                                        ...
                                        <td>{{item.draft}}</td>
                                        <td>{{item.lastPortZh}}</td>
                                        <td>{{item.exArriveFormat}}</td>
                                        <td>{{item.exNearFormat}}</td>
                                        <td>{{item.exLeaveFormat}}</td>
                                        <td>{{item.berth}}</td>
                                        <td>{{item.remark}}</td>
                                    </tr>
                                </tbody>
                    ...
                    <div class="ctrl-wrap sr-dialog zIndexZoom hide">
                        ...
                        <div class="ctrl-center">
                            <div class="ctrl-helght ctrl-explain">
                                <div class="ctrl-span">说明：</div>
                                <ul class="ctrl-ul">
                                    <li>
                                        <div>
                                            <i class="fs fs-kongzai text-green"></i>
                                        </div>
                                        <div class="ctrl-kongzai">空载</div>
                                    </li>
                                    <li>
                                        <div>
                                            <i class="fs fs-manzai text-green"></i>
                                        </div>
                                        <div class="ctrl-kongzai">满载</div>
                                    </li>
                                    <li>
                                        <div>
                                            <i class="fs fs-kongzai text-yell"></i>
                                        </div>
                                        <div class="ctrl-kongzai">空载船盘</div>
                                    </li>
                                    <li>
                                        <div>
                                            <i class="fs fs-manzai text-yell"></i>
                                        </div>
                                        <div class="ctrl-kongzai">满载船盘</div>
                                    </li>
                                </ul>
                                <!--<img src="../../static/images/ship/ctrlImg.png" alt="">-->
                            </div>
    ...
    export default {
        ...
        methods: {
                ...
                ShipPlateDetail(obj).then(res => {
                     ...
                     if(res.status == 401){
                        ...
                        window.location.href = configURL.sys + '/login.htm?returnUrl=' + encodeURIComponent(window.location.href);
                         ...
                         this.$alert('<span style="text-align: center; display: block; font-weight: bold;">您暂无权限</span>', '信息', {
            ...
            dialogMinZoom(info) {
                let _this = this;
                $(info.className).hide();
                _this.dialogMinZoomListRemove('id', info.id);
                _this.dialogMinZoomList.push(info);
            },
            //窗口放大
            dialogZoomShow(info) {
                let _this = this;
                $(info.className).show();
                _this.dialogMinZoomList.splice(_this.dialogMinZoomList.findIndex(item => item.id === info.id), 1)
                // _this.dialogMinZoomList.push(info);
            },
            dialogMinZoomListRemove(key, value) {
                let _this = this;
                let index = _this.dialogMinZoomList.findIndex(item => item[key] === value);
                if (index >= 0) {
                    _this.dialogMinZoomList.splice(index, 1)
                }
            },
            //<<<<选择时间改变轨迹查询
            changeRouteTime() {
            ...
            signOut() {
                ...
                window.location.href = configURL.sys + '/logout.htm?returnUrl=' + encodeURIComponent(window.location.href);
            },
            ...
            reqList() {
                ...
                $('.pannel_1').toggle();
                _this.dialogMinZoomListRemove('className', '.pannel_1');
            },
            //搜索港口分页
            pageFn(page) {
                var that = this;
            ...
            addBtnHistory() {
                if (this.full_searchFrom == '') {
                    this.$alert('<span style="text-align: center; display: block; font-weight: bold;">发货港不能为空</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                    return false
                ...
                if (this.loadPort3 == '') {
                    this.$alert('<span style="text-align: center; display: block; font-weight: bold;">收货港不能为空</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                    return false
                ...
                //                    this.$alert('<span style="text-align: center; display: block; font-weight: bold;">船型不能为空</span>', '信息', {
                //                        dangerouslyUseHTMLString: true,
                //                        showClose: false,
                //                    });
                //                    return false
                ...
                if (this.num1 == '' || this.num2 == '') {
                    //                    this.$alert('<span style="text-align: center;">DWT数据不能为空</span>', '信息', {
                    //                        dangerouslyUseHTMLString: true,
                    //                        showClose: false,
                    //
                } else {
                    ...
                    if (num) {
                        this.$alert('<span style="text-align: center; display: block; font-weight: bold;">请输入数字</span>', '信息', {
                            dangerouslyUseHTMLString: true,
                            showClose: false,
                        });
                        return false
                        ...
                        if (parseFloat(this.num2) - parseFloat(this.num1) <= 0) {
                            this.$alert('<span style="text-align: center; display: block; font-weight: bold;">请正确输入数字顺序</span>', '信息', {
                                dangerouslyUseHTMLString: true,
                                showClose: false,
                            });
                            return false
                ...
                if (this.time3 == '' || this.time4 == '' || this.time3 == null || this.time4 == null) {
                    this.$alert('<span style="text-align: center; display: block; font-weight: bold;">日期不能为空</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                    return false
                    ...
                    if (this.time3 > this.time4) {
                        this.$alert('<span style="text-align: center; display: block; font-weight: bold;">结束日期不能小于起始日期</span>', '信息', {
                            dangerouslyUseHTMLString: true,
                            showClose: false,
                        });
                        return false
                    ...
                    if (tday > 180) {
                        this.$alert('<span style="text-align: center; display: block; font-weight: bold;">时间范围不能超过180天</span>', '信息', {
                            dangerouslyUseHTMLString: true,
                            showClose: false,
                        });
                        return false
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.datas.data.length > 0) {
                                ...
                                //导出数据
                                that.exportMsg = `${that.url}/api/export/historyport.htm?fromPort=${that.full_searchFrom}&toPort=${that.loadPort3}&sizeType=${$$shipType}&timeType=${$$timeType}&dwtMaxValue=${that.num2}&dwtMinValue=${that.num1}&startTime=${new Date(that.time3.toString()).getTime()}&endTime=${new Date(that.time4.toString()).getTime()}`
                            } else {
                                that.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无历史航线数据</span>', '信息', {
                                    dangerouslyUseHTMLString: true,
                                    showClose: false,
                                });
                            }
            ...
            harborSearch() {
                ...
                if (that.time1 != '' && that.time2 != '') {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.datas != null && data.datas.length != 0) {
                                ...
                                loadingInstance.close();
                                that.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无当前日期数据</span>', '信息', {
                                    dangerouslyUseHTMLString: true,
                                    showClose: false,
                                });
                            }
                    ...
                    that.$alert('<span style="text-align: center; display: block; font-weight: bold;">请输入日期</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                }
            ...
            //敬请期待
            coming() {
                this.$alert('<span style="text-align: center; display: block; font-weight: bold;">敬请期待</span>', '信息', {
                    dangerouslyUseHTMLString: true,
                    showClose: false,
                });
            },
            ...
            deleteLine2() {
                if (this.lineList2.length > 1) {
                    ...
                    this.$alert('<span style="text-align: center; display: block; font-weight: bold;">至少保留一个港口</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                }
            ...
            //>>>>>>>>>航线航速上移功能
            toUpList() {
                var index = $('.tableBody1 .tableRowOne .activeItem').parent().index() - 1;
                var _this = this;
                if (index > 0) {
                    ...
                    this.$alert('<span style="text-align: center; display: block; font-weight: bold;">无法与第一行交换</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                } else {
                    this.$alert('<span style="text-align: center; display: block; font-weight: bold;">请选择一行</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                }
            ...
            toDownList() {
                ...
                if (index < _this.lineList.length - 1 && index >= 0) {
                    ...
                    this.$alert('<span style="text-align: center; display: block; font-weight: bold;">当前已是最后一行</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                } else if (index < 0) {
            ...
            laoShiDangAn() {
                ...
                Lloydsfile(para).then(res => {
                    ...
                    if (res.datas != null) {
                        ...
                        loadingInstance.close();
                        this.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无数据</span>', '信息', {
                            dangerouslyUseHTMLString: true,
                            showClose: false,
                        });
                    }
                ...
                if ($('.pannel_23').hasClass('hide')) {
                    ...
                    weatherForecast(param).then(res => {
                        ...
                        if (res.status == 0 && res.datas != null && res.datas.length != 0) {
                            ...
                            loadingInstance.close();
                            this.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无气象信息</span>', '信息', {
                                dangerouslyUseHTMLString: true,
                                showClose: false,
                            });
                        }
                ...
                /*$.ajax({
                    ...
                    success:  (data) => {
                        ...
                        if (data.datas.length != 0) {
                            ...
                            this.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无当前港口排队计划数据</span>', '信息', {
                                dangerouslyUseHTMLString: true,
                                showClose: false,
                            })
        ...
        mounted() {
            ...
            function initMap() {
                ...
                function showArrays(event) {
                    var contentString = '<p>索马里海盗高风险区</p>';
                ...
                $('.tryQuery').on('click', function () {
                    if ($('.get-imo').text() != '' && _this.time1 != '' && _this.time1 != null && _this.time2 != '' && _this.time2 != null) {
                        if (_this.time1 > _this.time2) {
                            _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">结束日期不能小于起始日期</span>', '信息', {
                                dangerouslyUseHTMLString: true,
                                showClose: false,
                            });
                        } else {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data.point.length !=0 && data.length != 0) {
                                        ...
                                        _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无轨迹</span>', '信息', {
                                            dangerouslyUseHTMLString: true,
                                            showClose: false,
                                        });
                                    }
                        ...
                        _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">请输入日期</span>', '信息', {
                            dangerouslyUseHTMLString: true,
                            showClose: false,
                        });
                    }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.features.length != 0) {
                                ...
                                function contrastShipFun() {
                                    console.log(contrast[0].imo)

                                    var isImo = data.features[0].properties.shipMessage.IMO;
                                    console.log(isImo);
                               ...
                               /* $('.zIndexZoom').removeClass('zIndex');
                                ...
                                _this.loading.close();
                                _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">没有此船</span>', '信息', {
                                    dangerouslyUseHTMLString: true,
                                    showClose: false,
                                });
                            }
                ...
                $('.ship-search-a').on('click', function () {
                    if ($('.close-1').is(':hidden')) {
                        if ($('.sear_input').val() != '') {
                            ...
                            _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">船名/IMO输入不能为空</span>', '信息', {
                                dangerouslyUseHTMLString: true,
                                showClose: false,
                            });
                        }
            ...
            $('.sear_input').keyup(function (event) {
                if ($(this).val() != '') {
                    if (event.keyCode == 38) {
                        ...
                        if (index <= 0) {
                            index = 0;
                            $('.fullz-z').find('li').eq(index).addClass('fullcurrent');
                            $('.fullz-z').find('li').not($('.fullz-z').find('li').eq(index)).removeClass('fullcurrent');
                        } else {
                            if (index == 7) {
                            ...
                            if (index > 7) {
                                if ((index + 1) % 7 == 1) {
                                    $(".fullz-z ul").scrollTop(30 * 7 * parseInt(index / 7) - 210);
                                }
                            }
                            $('.fullz-z').find('li').eq(index - 1).addClass('fullcurrent');
                            $('.fullz-z').find('li').not($('.fullz-z').find('li').eq(index - 1)).removeClass('fullcurrent');
                        }
                    }
                    if (event.keyCode == 40) {
                        index++;
                        ...
                        if (index > 7) {
                            if (index % 7 == 1) {
                                $(".fullz-z ul").scrollTop(30 * 7 * parseInt(index / 7));
                            }
                        }
                    }
                }
            ...
            $('.ctrl-type-radiu .item').click(function () {
                ...
                result == 1?portFlag = true:portFlag = false;
            ...
            $('.typhoonSearch').click(function () {
                ...
                if (_this.typhoonTime1.getTime() < _this.typhoonTime2.getTime()) {
                    if (_this.typhoonTime2.getTime() - _this.typhoonTime1.getTime() < 5356800000) {
                        ...
                        typhoon(obj).then(res => {
                            ...
                            if (res != null && res != '') {
                                ...
                                if (res.datas.length == 0) {
                                    if (status == 0) {
                                        _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无台风信息</span>', '信息', {
                                            dangerouslyUseHTMLString: true,
                                            showClose: false,
                                        });
                                    } else {
                        ...
                        _this.$alert('<span style="text-align: center; display: block; font-weight: bold;"> 时间范围只限两个月以内</span>', '信息', {
                            dangerouslyUseHTMLString: true,
                            showClose: false,
                        });
                    ...
                    _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">开始日期不能大于结束日期</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                }
            ...
            $('body').on('click', '.posCenter', function () {
                ...
                map.setCenter(posCenterArr[i - 1]);
                map.setZoom(5);
            });
            //点击 气象 台风海盗军演 清除地图数据
                ...
                if ($('.pirate-wrap').attr('data-value') != '') {
                    ...
                    navigationWarning(dataObj).then(res => {
                        ...
                        if (res != null && res != '') {
                            ...
                            _this.loading.close();
                            _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无此类型船只</span>', '信息', {
                                dangerouslyUseHTMLString: true,
                                showClose: false,
                            });
                        }
                    ...
                    _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">输入不能为空</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                }
            ...
            $('.fs-pre_doub').click(function () {
                if ($('.windWaveStream').attr('data-value') != '') {
                    ...
                    _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">请选择至少一种气象类型</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                }
            ...
            $('.search-button').click(function () {
                ...
                if ($($('.radio-list')[0]).hasClass('fs-circle-select')) { //当前在港
                    if ($haven != '') {
                        ...
                        _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">请选择港口</span>', '信息', {
                            dangerouslyUseHTMLString: true,
                            showClose: false,
                        });
            ...
            $('body').on('click', '.tableRowOne3', function () {
                ...
                _this.initPortName = _this.reachLogs1[$(this).index()].portNameCn;

                _this.initPortNameEn = _this.reachLogs1[$(this).index()].portNameEn;

                _this.initPortCurrent = _this.reachLogs1[$(this).index()].counrtyCn;
                ...
                google.maps.event.addListener(portMark, "click", function () {
                    ...
                    _this.initPortName = this.data.portNameCn;

                    _this.initPortNameEn = this.data.portNameEn;

                    _this.initPortCurrent = this.data.counrtyEn;
            ...
            $('.radio_group-1 label').click(function (event) {
                ...
                if ($(this).find('span').text() == '当前在港') {
                    $('#sailState').hide();
                    $('.timer-list').hide();
                    _this.loadPortArr = dataResultPort;
                } else if ($(this).find('span').text() == '预计到港') {
                    $('#sailState').show();
                    $('.timer-list').show();
                    _this.loadPortArr = dataResultPort1;
                } else if ($(this).find('span').text() == '历史到港') {
                    $('#sailState').hide();
                    $('.timer-list').show();
                    _this.loadPortArr = dataResultPort1;
                }
            ...
            $('.routeLineClick').click(function () {
                ...
                _this.lineVal2 = "经度：" + lngFormatter(Number(_this.isLatLng.lng).toFixed(5).toString()) + ' 纬度：' + latFormatter(Number(_this.isLatLng.lat).toFixed(5).toString());
            });
            //>>>>>>>>>>>>>>>>>>>航速航线船型选择
            ...
            $('.calculate1').click(function () {
                ...
                if (len < 0) {
                    _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">至少选择两个港口</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                } else {
                    ...
                    if (newStr == true) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data.datas != null && data.datas.data.data.length != 0) {
                                    ...
                                    setTimeout(function () {
                                        for (let i = 0; i < portMsg.length; i++) {
                                            $('.route-port').eq(i).find('.infoWindow-span1').html(portMsg[i].nameCn);
                                    ...
                                    _this.loading.close();
                                    _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无计算方案</span>', '信息', {
                                        dangerouslyUseHTMLString: true,
                                        showClose: false,
                                    });
                                }
                        ...
                        _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">港口不能为空</span>', '信息', {
                            dangerouslyUseHTMLString: true,
                            showClose: false,
                        });
                    }
            ...
            $('.calculate2').click(function () {
                ...
                if (len < 0) {
                    _this.$alert('<span style="text-align: center">至少选择一个港口</span>', '信息', {
                        dangerouslyUseHTMLString: true,
                        showClose: false,
                    });
                    return false;
                    ...
                    if (newStr == true) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data.datas != null) {
                                    ...
                                    _this.loading.close();
                                    _this.$alert('<span style="text-align: center">暂无计算方案</span>', '信息', {
                                        dangerouslyUseHTMLString: true,
                                        showClose: false,
                                    });
                                }
                        ...
                        _this.$alert('<span style="text-align: center">港口不能为空</span>', '信息', {
                            dangerouslyUseHTMLString: true,
                            showClose: false,
                        });
                    }
            ...
            $('.coming').on('click', function () {
                _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">敬请期待</span>', '信息', {
                    dangerouslyUseHTMLString: true,
                    showClose: false,
                });
            });
                        ...
                        for (let i = 0; i < portList.length; i++) {
                            ...
                            google.maps.event.addListener(portResult, "click", function () {
                                ...
                                if (map.getZoom() > 6) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (data) {
                                            if (data != null && data.datas && data.datas.seaport.currents.length != 0) {
                                                ...
                                                _this.isPortDate = data.datas.date;
                                    ...
                                    //var point = LatLng2Pixel(map, new google.maps.LatLng(this.data.lat, this.data.lng));
                                    //_this.portForeign == 1?$('.current-port').hide():$('.current-port').show()
                                    $('.port-details-wrap').removeClass('hide');
            ...
            function delShipGreYel() {
                ...
                if (shipMarkerGreArr.length != 0) {
                    ...
                    //shipMarkerGreArr.splice(0,shipMarkerGreArr.length);
                ...
                if (shipMarkerYelArr.length != 0) {
                    ...
                    //shipMarkerYelArr.splice(0,shipMarkerYelArr.length);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.datas !=null) {
                            ...
                            _this.export1 = `${_this.url}/api/export/now.htm?dwtMaxValue=${dataObj.dwtMaxValue}&dwtMinValue=${dataObj.dwtMinValue}&portNameEn=${dataObj.portNameEn}&sizeType=${dataObj.sizeType}`;
                            ...
                            if (portShip != null) {
                                ...
                                if (data.datas.data != null && data.datas.data.length !=0) {
                                    ...
                                    _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">当前港口暂无船只数据</span>', '信息', {
                                        dangerouslyUseHTMLString: true,
                                        showClose: false,
                                    });
                                ...
                                $('#sr-d9').hide();
                                _this.$alert('<span style="text-align: center; display: block; font-weight: bold;">暂无数据</span>', '信息', {
                                    dangerouslyUseHTMLString: true,
                                    showClose: false,
                                });
                            }
                            ...
                            setTimeout(function () {
                                $('.info-window-wrap .infoWindow-span1').html(data.datas.html.nameCn);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.datas != null) {
                            ...
                            _this.export2 = `${_this.url}/api/export/expected.htm?endTime=${dataObj.endTime}&naviStatus=${dataObj.naviStatus}&pageIndex=-1&pageSize=-1&portNameEn=${dataObj.portNameEn}&startTime=${dataObj.startTime}&sizeType=${dataObj.sizeType}`;

                            var portLatLng2 = {
                                lat: Number(data.datas.html.lat),
                                lng: Number(data.datas.html.lng)
                            };
                            ...
                            if (portShip != null) {
                                ...
                                for (let i = 0; i < portShip.length; i++) {
                                    ...
                                    var speed = portShip[i].speed != null?portShip[i].speed+'节' : '';
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.datas != null) {
                            ...
                            _this.export3 = `${_this.url}/api/export/current.htm?endTime=${dataObj.endTime}&portNameEn=${dataObj.portNameEn}&sizeType=${dataObj.sizeType}&startTime=${dataObj.startTime}`;
                            var portLatLng3 = {
                                lat: data.datas.html.lat,
                                lng: data.datas.html.lon
                            };
