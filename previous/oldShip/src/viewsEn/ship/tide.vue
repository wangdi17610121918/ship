<template>
	<section>
		<!--港口码头-->
		<div class="inner">
			<div class="tide-title"><a href="javascript:;" @click="getActive()">Index</a>&gt;&gt;<a href="/page/" class="cur">SHIPPING</a>&gt;&gt;<a href="javascript:;" class="cur">TIDE</a></div>
			<div class="tide-search">
				<ul class="tide-search-list clearfix">
					<li>Port</li>
					<li>
						<el-select v-model="region" placeholder="Region" size="mini"  @change="change(region,'countryArr')">
							<el-option
					...
					<li>
						<el-select v-model="country" placeholder="State" size="mini"  @change="change(country,'provinceArr')">
							<el-option
					...
					<li>
						<el-select v-model="province" placeholder="Province" size="mini"   @change="change(province,'portArr')">
							<el-option
					...
					<li class="ry-elemetLi">
						<el-select v-model="port" placeholder="Port" size="mini" @change="teChange" >
							<el-option
					...
					<li><a href="javascript:;" @click="seachFn">Search</a></li>
				</ul>
				<ul class="tide-search-hot clearfix">
					<li>Hot Port</li>
					<li><a href="javascript:;" @click="portFn($event,'TIWU')" class="ry-tide-active">TIWU</a></li>
					<li><a href="javascript:;" @click="portFn($event,'DALIAN')">DALIAN</a></li>
					<li><a href="javascript:;" @click="portFn($event,'QINGDAO')">QINGDAO</a></li>
					<li class="fixed_width"><a href="javascript:;" @click="portFn($event,'RIZHAO（LANSHAN）')">RIZHAO（LANSHAN）</a></li>
					<li><a href="javascript:;" @click="portFn($event,'TANGSHAN')">TANGSHAN</a></li>
					<li><a href="javascript:;" @click="portFn($event,'ZHENHAI')">ZHENHAI</a></li>
					<li><a href="javascript:;" @click="portFn($event,'NINGBO')">NINGBO</a></li>
				</ul>
			</div>
			<div>
				...
				<div class="tide-table-box">
					<div class="tide-table-title"><i class="shipping-ico ico-tide-table"></i>TIDE</div>
...
<style>
	...
	.tide-search-line li{width: 39% !important;}
	.el-date-table__row .current{border: none !important;}
	.timeP .el-input__suffix i.el-input__icon{display: none;}
</style>